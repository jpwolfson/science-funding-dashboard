...
| `Verify main` runs 35625099096, 35642634576, 35757926880, 35763930912, 35791555248 | after each refresh | **success ×5** | `verify.py --tier fast` PASS on `main` after the partial award refresh, the sentinel snapshot, and the obligation snapshot. Issue #69 (the 2026-09-17 fast-tier failure, closed by W1) closed 2026-09-22. |
...
- W16 (render curated `periodNotes`; owner decision 2026-09-21: render as
  ...
  `claude/w16-render-period-notes`, PR #[W16-PR]. Adds `publicNote` to the
...
| 2026-09-21/22 | `Verify main` runs 35625099096, 35642634576, 35757926880, 35763930912, 35791555248 | fast tier on `main` after each refresh | **success ×5**; issue #69 closed |
